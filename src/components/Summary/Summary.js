      ...
      <section id = "about-me" className="summary-container">
        <div className="summary-content">
          ...
          <p className="summary-description">
            {" "}
            Effective Student pursuing a Software Engineering degree committed to 
            learning, developing skills in Mobile App Development and team contribution.
            Capable of self-managing and working independently or collaborating with others
            on group projects. Successful in quickly building skills and acquiring new knowledge. 
