  ...
  render() {
    ...
    return (
      ...
      <div className="recommendation-list-content">
        <Recommendation className= "recommendation" image = "https://playjoor.com/assets/avatar/matthew.png" name= "Federico" paragraph={paragraph3} position= "Director at SLF"/>
