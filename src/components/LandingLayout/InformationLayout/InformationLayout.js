  ...
  render() {
    return (
      ...
      <h1 className="title">
        ...
        <hr />
        <div className="socialContactsIcons gridIconLayout">
            <a href = "https://github.com/tarekait1996"><i className="fab fa-github-alt"></i></a>
            <a href = "https://www.linkedin.com/in/tarek-ait-hamouda/"><i className="fab fa-linkedin"></i></a>
