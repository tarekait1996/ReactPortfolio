...
export default class Project extends React.Component {
  render() {
    const htnString =
    " I had the priviledge of being one of the 1,500 students selected to attend Canada's Biggest Hackathon at University of Waterloo. During this 36 hours long hackathon, my team (four developers with different backgrounds/expertise including myself) created an Android application that would help people who have allergies. The app would allow a user to sign in and enter information regarding his allergies in his prodile. Then, the user can take pictures from either the gallery or camera of a product ingredient label and know whether he could have an allergy to the product. The application uses OCR (Google AI Vision API) to analyze the photo selected as well as some data on the Firebase database that was set. In addition, the user can also find recipees of food that he wants and that does not contain an ingredient that he is allergic to.  ";
  const devBlockString =
    " During this 24 hours long hackathon, my team created a social platform for refugees.The Helping Hand website offers various useful information such as where a refugee could get free food, clothes, furniture and other free goods. To do this, we show a map with pins that represents where those goods are distributed. The prototype could be further expanded to offer alerts when new items are available, and more. We used the MEAN stack to build the website (MongoDB, ExpressJS, Angular, NodeJS).";
  const twatterString =
